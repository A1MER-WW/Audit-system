  ...
  <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
    ...
    <div className="rounded-lg border bg-gray-50 p-6">
      <h3 className="text-sm font-semibold text-gray-900 mb-4 text-left">
        จำนวนหมวดหมู่ของปัจจัยเสี่ยงในแต่ละด้าน
      </h3>

      {/* ค่าตามภาพตัวอย่าง (ซ้ายแต่ละด้านรวม ~12–15) */}
      {/*
        ลำดับสีเหมือน legend: สูงมาก #DC2626, สูง #EA580C, ปานกลาง #D97706,
        น้อย #059669, น้อยมาก #2563EB
      */}
      <div className="flex items-end justify-between gap-2 h-56 px-4">
        {[
          { label: "ด้านกลยุทธ์", values: [3,3,3,3,3] },
          { label: "ด้านการเงิน", values: [2,3,3,3,3] },
          { label: "ด้านการดำเนินงาน", values: [2,2,3,3,2] },
          { label: "ด้านกฎหมาย/ระเบียบ", values: [2,2,2,3,3] },
          { label: "ด้านเทคโนโลยีสารสนเทศ", values: [1,2,2,3,3] },
          { label: "ด้านการเกิดทุจริต", values: [3,3,2,2,2] },
        ].map((cat, idx) => {
          const colors = ["#DC2626","#EA580C","#D97706","#059669","#2563EB"];
          const sum = cat.values.reduce((a,b)=>a+b,0);
          const maxInCol = Math.max(...cat.values);
          return (
            <div key={idx} className="flex flex-col items-center flex-1">
              <div className="text-center mb-1">
                <div className="text-base font-semibold text-gray-900">{sum}</div>
              </div>
              <div className="flex flex-col-reverse items-stretch h-40 w-16 rounded overflow-hidden">
                {cat.values.map((v,i)=>(
                  <div
                    key={i}
                    className="w-full text-[10px] text-white font-bold flex items-center justify-center border-b border-white/20"
                    style={{
                      backgroundColor: colors[i],
                      height: `${Math.max((v / maxInCol) * 34, 8)}px`,
                    }}
                  >
                    {v}
                  </div>
              ...
              <div className="text-[10px] text-gray-700 text-center mt-2 leading-tight max-w-20">
                {cat.label}
              </div>
            </div>
          );
      ...
      {/* Legend */}
      <div className="mt-4 flex flex-wrap justify-center gap-3 text-xs bg-white rounded-lg p-3 border">
        {[
          { c:"#DC2626", t:"สูงมาก" },
          { c:"#EA580C", t:"สูง" },
          { c:"#D97706", t:"ปานกลาง" },
          ...
          <div key={i} className="flex items-center gap-1">
            <span className="inline-block w-3 h-3 rounded" style={{backgroundColor:it.c}} />
    ...
    {/* ================== RIGHT : DONUT ================== */}
    <div className="rounded-lg border bg-gray-50 p-6 relative">
      <h3 className="text-sm font-semibold text-gray-900 mb-4 text-left">
