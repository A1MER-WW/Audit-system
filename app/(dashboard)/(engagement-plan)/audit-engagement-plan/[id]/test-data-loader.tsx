...
export default function TestDataLoader() {
  ...
  const loadTestData = () => {
    ...
    dispatch({
      type: 'UPDATE_STEP2',
      payload: {
        auditIssues: "การประเมินประสิทธิภาพและประสิทธิผลของโครงการ รวมถึงการตรวจสอบการปฏิบัติตามระเบียบและข้อกำหนดที่เกี่ยวข้อง การตรวจสอบกระบวนการจัดทำแผนงาน และการติดตามความคืบหน้าของโครงการ",
        objectives: [
