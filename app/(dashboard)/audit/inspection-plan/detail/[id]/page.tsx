...
export default function InspectionPlanDetailPage({ params }: Props) {
      ...
      case 4:
        return (
          <div className="space-y-4 md:space-y-6">
            {/* Audit Plan Table */}
            <div className="space-y-4">
              <h3 className="text-base md:text-lg font-semibold">ขอบเขตการปฏิบัติงานตรวจสอบ</h3>
              
              {/* แผนการตรวจสอบภายในประจำปี Section */}
              <div className="space-y-4">
                <h4 className="font-medium text-sm">ประเภทของการตรวจสอบ: การบริการให้ความเชื่อมั่น</h4>
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300 text-xs">
                    <thead>
                      <tr className="bg-gray-50">
                        <th className="border border-gray-300 p-2 text-left">ลำดับ</th>
                        <th className="border border-gray-300 p-2 text-left">กิจกรรมที่ตรวจสอบ/หน่วยรับตรวจ</th>
                        <th className="border border-gray-300 p-2 text-left">ประเภทของการตรวจสอบ</th>
                        <th className="border border-gray-300 p-2 text-left">ปี 2568</th>
                        <th className="border border-gray-300 p-2 text-left">ปี 2569</th>
                        <th className="border border-gray-300 p-2 text-left">ปี 2570</th>
                        <th className="border border-gray-300 p-2 text-left">หมายเหตุ</th>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 p-2">ผลการดำเนินโครงการศูนย์เรียนรู้การเพิ่มประสิทธิภาพการผลิตสินค้าเกษตร</td>
                        <td className="border border-gray-300 p-2">การปฏิบัติตามกฎระเบียบ</td>
      ...
      case 4:
        return (
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-blue-700">งานบริการให้ความเชื่อมั่น</h3>
              <p className="text-sm text-gray-600">แผนการตรวจสอบ การสอบทาน และการให้ความเชื่อมั่น</p>
              
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300 text-sm">
                  <thead>
                    <tr className="bg-blue-50">
                      <th className="border border-gray-300 p-3 text-center w-12">ลำดับ</th>
                      <th className="border border-gray-300 p-3 text-left">เรื่องงานตรวจสอบ/หัวข้อการตรวจ</th>
                      <th className="border border-gray-300 p-3 text-left">หน่วยรับบริการตรวจสอบ</th>
                      <th className="border border-gray-300 p-3 text-center w-20">ปี 2568</th>
                      <th className="border border-gray-300 p-3 text-center w-20">ปี 2569</th>
                      <th className="border border-gray-300 p-3 text-center w-20">ปี 2570</th>
                      <th className="border border-gray-300 p-3 text-left w-32">หมายเหตุ</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">1</td>
                      <td className="border border-gray-300 p-3">แผนการดำเนินโครงการศูนย์เรียนรู้การเพิ่มประสิทธิภาพการผลิตสินค้าเกษตร</td>
                      <td className="border border-gray-300 p-3">กลุ่มอำนวยการแปลใน</td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">การสอบทานและประเมินผลการควบคุมภายในและการติดตามผลการดำเนินการแผนการควบคุมภายในของกลุ่มงานตรวจสอบภายใน การสอบทานการปรับปรุงสำหรับประจำปี งบประมาณ งาน สถาบัน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานจราจร</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                      <td className="border border-gray-300 p-3 text-center">
                      ...
                      <td className="border border-gray-300 p-3">กลุ่มงานงบใน</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">3</td>
                      <td className="border border-gray-300 p-3">การจัดทำรายงานการสอบทานการประเมินผลสถานที่ได้ปฏิบัติภายในในที่ สตท.</td>
                      <td className="border border-gray-300 p-3">กลุ่มอำนวยการแปลใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">การทบทวนและปรับปรุงแผนการตรวจสอบภายในและการวิเคราะห์ความเสี่ยงปฏิบัติภายในในที่ สตท.</td>
                      <td className="border border-gray-300 p-3">กลุ่มอำนวยการแปลใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">การตรวจสอบการปฏิบัติตามงานตรวจสอบการปฏิบัติที่มีผลการและปฏิบัติการที่เกี่ยวข้องกับงานส่วนภายใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มอำนวยการแปลใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">การตรวจสอบและประเมินผลการจัดการความเสี่ยงในหน่วยงานที่ใช้การวิเคราะห์ผลจากความมุ่งหวังนที่งาน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานจราจร</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">แผนการดำเนินงานโครงการจัดทำเว็บระบบแผนผังผู้ให้การควบคุมเพื่อนเลขที่ปฏิบัติการปฏิบัติงานเพื่อผลิตกยวาร</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานจราจร</td>
                      <td className="border border-gray-300 p-3 text-center"></td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">ติดตามความก้าวหน้าการให้คำแนะนำการพัฒนาการบริหารความเสี่ยงอันดับใน 1 ปรับปรุงคำแนะนำควบคุมภายใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มอำนวยการแปลใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">ให้การติดตามแนวทางการตรวจสอบการบำบัดปัญหายำสานการแปลใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานจราจร</td>
                      <td className="border border-gray-300 p-3 text-center"></td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                    ...
                    <tr>
                      ...
                      <td className="border border-gray-300 p-3">ให้การติดตามแนวทางการตรวจสอบงานจัดซื้อจัดจ้างการแปลใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานจราจร</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
            ...
            {/* งานบริการให้คำปรึกษา แบบให้คำปรึกษาแผนงาน/โครงการ */}
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-blue-700">งานบริการให้คำปรึกษา แบบให้คำปรึกษาแผนงาน/โครงการ</h3>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300 text-sm">
                  ...
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">1</td>
                      <td className="border border-gray-300 p-3">การตรวจสอบการดูแลรักษาหนังสือหรือเอกสารและทรัพย์สินสำนักงาน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                      <td className="border border-gray-300 p-3 text-center">
            ...
            {/* งานบริการให้คำปรึกษา แบบให้คำปรึกษาเฉพาะเรื่อง */}
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-blue-700">งานบริการให้คำปรึกษา แบบให้คำปรึกษาเฉพาะเรื่อง</h3>
              ...
              <div className="overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300 text-sm">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">2</td>
                      <td className="border border-gray-300 p-3">การสอบทานและประเมินผลการควบคุมภายในและการติดตามผลการดำเนินการแผนการควบคุมภายในของกลุ่มงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงาน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                      <td className="border border-gray-300 p-3 text-center">
                      ...
                      <td className="border border-gray-300 p-3">กลุ่มงานใน</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">3</td>
                      <td className="border border-gray-300 p-3">การจัดทำรายงานการสอบทานการประเมินผลการควบคุมภายใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">4</td>
                      <td className="border border-gray-300 p-3">การทบทวนและปรับปรุงแผนการตรวจสอบภายในประจำปี และการวิเคราะห์งาน ในการ สอบ</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">5</td>
                      <td className="border border-gray-300 p-3">การติดตามความก้าวหน้าในการปฏิบัติตามข้อเสนอแนะในรายงานผลการตรวจสอบ และความก้าวหน้าสำหรับการปฏิบัติตาม</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">6</td>
                      <td className="border border-gray-300 p-3">การตรวจสอบระบบเทคโนโลยีสารสนเทศและการสื่อสารของการทำงาน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงาน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">7</td>
                      <td className="border border-gray-300 p-3">การตรวจสอบการใช้ทรัพยากรที่สำคัญของกิจการตรวจสอบภายในการจัดการการปฏิบัติการประจำที่สำนักงาน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงาน</td>
                      <td className="border border-gray-300 p-3 text-center"></td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">8</td>
                      <td className="border border-gray-300 p-3">ติดตามความก้าวหน้าในการปฏิบัติตามแผนการบริหารความเสี่ยงและ ก 1 การควบคุมภายในการเทคโนโลยีและการปฏิบัติตาม</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                      </td>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">9</td>
                      <td className="border border-gray-300 p-3">ให้คำปรึกษาและการสนับสนุนในการปฏิบัติงานตรวจสอบภายใน</td>
                      <td className="border border-gray-300 p-3">กลุ่มงาน</td>
                      <td className="border border-gray-300 p-3 text-center"></td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
                    ...
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">10</td>
                      <td className="border border-gray-300 p-3">ให้คำปรึกษาดำเนินการตรวจสอบในการปฏิบัติการตรวจสอบ</td>
                      <td className="border border-gray-300 p-3">กลุ่มงาน</td>
                      <td className="border border-gray-300 p-3 text-center"></td>
                      <td className="border border-gray-300 p-3 text-center">
                        <span className="text-green-600 text-lg">✓</span>
            ...
            {/* Summary Text */}
            <div className="bg-yellow-100 p-4 rounded border text-sm">
              <p>รายชื่อผู้ใช้ที่ใช้ในการปฏิบัติการตรวจสอบ = 1,085 วันทำการ โดยไม่นับวันหยุด ลาพัก 5 วัน ครั้ง เฉลี่ยวันอื่นให้ถึงการตรวจสอบประมาณ 217 วันทำการ/คน</p>
            </div>

            {/* ประมาณการงาน/งบประมาณในการปฏิบัติงาน */}
            <div className="space-y-4">
              <h3 className="text-base font-semibold text-blue-700">ประมาณการงาน/งบประมาณในการปฏิบัติงาน</h3>
                ...
                <table className="w-full border-collapse border border-gray-300 text-sm">
                  <thead>
                    <tr className="bg-blue-50">
                      <th className="border border-gray-300 p-3 text-center w-12">ลำดับ</th>
                      <th className="border border-gray-300 p-3 text-left">เรื่องงานตรวจสอบ/หัวข้อการตรวจ</th>
                      <th className="border border-gray-300 p-3 text-center w-24">ปี 2568</th>
                      <th className="border border-gray-300 p-3 text-center w-24">ปี 2569</th>
                      <th className="border border-gray-300 p-3 text-center w-24">ปี 2570</th>
                      <th className="border border-gray-300 p-3 text-left w-32">หมายเหตุ</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">1</td>
                      <td className="border border-gray-300 p-3">คำจำแนกการอำนวยการ</td>
                      <td className="border border-gray-300 p-3 text-right">105,000</td>
                      <td className="border border-gray-300 p-3 text-right">126,000</td>
                      <td className="border border-gray-300 p-3 text-right">143,000</td>
                      <td className="border border-gray-300 p-3"></td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">2</td>
                      <td className="border border-gray-300 p-3">คำจำแนกการจัดการกิจกรรมคำปรึกษา</td>
                      <td className="border border-gray-300 p-3 text-right">80,830</td>
                      <td className="border border-gray-300 p-3 text-right">104,896</td>
                      <td className="border border-gray-300 p-3 text-right">133,389</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานใน</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">3</td>
                      <td className="border border-gray-300 p-3">คำวิชาการ</td>
                      <td className="border border-gray-300 p-3 text-right">278,000</td>
                      <td className="border border-gray-300 p-3 text-right">334,400</td>
                      <td className="border border-gray-300 p-3 text-right">401,440</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานใน</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">4</td>
                      <td className="border border-gray-300 p-3">คำ อุปกรณ์</td>
                      <td className="border border-gray-300 p-3 text-right">64,595</td>
                      <td className="border border-gray-300 p-3 text-right">80,349</td>
                      <td className="border border-gray-300 p-3 text-right">96,534</td>
                      <td className="border border-gray-300 p-3">กลุ่มงานใน</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">5</td>
                      <td className="border border-gray-300 p-3">สาธารณูปโภค</td>
                      <td className="border border-gray-300 p-3 text-right">26,000</td>
                      <td className="border border-gray-300 p-3 text-right">30,400</td>
                      <td className="border border-gray-300 p-3 text-right">31,200</td>
                      <td className="border border-gray-300 p-3"></td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">6</td>
                      <td className="border border-gray-300 p-3">สาธารณการ ประเสริญ</td>
                      <td className="border border-gray-300 p-3 text-right">53,500</td>
                      <td className="border border-gray-300 p-3 text-right">54,300</td>
                      <td className="border border-gray-300 p-3 text-right">73,600</td>
                      <td className="border border-gray-300 p-3"></td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">7</td>
                      <td className="border border-gray-300 p-3">คำตอบแทนคิน</td>
                      <td className="border border-gray-300 p-3 text-right">2,900</td>
                      <td className="border border-gray-300 p-3 text-right">3,480</td>
                      <td className="border border-gray-300 p-3 text-right">4,176</td>
                      <td className="border border-gray-300 p-3"></td>
                    </tr>
                    <tr>
                      <td className="border border-gray-300 p-3 text-center">8</td>
                      <td className="border border-gray-300 p-3">คำจำแนกการจ่ายเงินกองทุนเครือครัว</td>
                    ...
                    <tr className="bg-yellow-100 font-semibold">
                      <td className="border border-gray-300 p-3 text-center" colSpan={2}>รวมงบประมาณทั้งหมด</td>
                      <td className="border border-gray-300 p-3 text-right">706,825</td>
                      <td className="border border-gray-300 p-3 text-right">841,626</td>
                      <td className="border border-gray-300 p-3 text-right">989,561</td>
                      <td className="border border-gray-300 p-3"></td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="text-right font-semibold text-base">
              <p>รวมงบประมาณทั้งหมด: 50,000</p>
            </div>

            {/* Final Notes */}
            <div className="bg-gray-50 p-4 rounded border text-sm space-y-2">
              <p className="font-semibold">หมายเหตุ:</p>
              <p>1 ปีงบประมาณในการปฏิบัติงานตรวจสอบประกอบด้วย ค่าใช้จ่าย ค่าเดินทาง ค่าเบี้ยเลี้ยง ค่าเช่าที่พัก ค่าพาหนะ ค่าการสำรวจ เจ้าหน้าที่ หาง เจ้าหน้าที่อำนวยความสะดวก และค่าใช้จ่ายอื่น ๆ ที่จำเป็นแก่การปฏิบัติงาน</p>
              <p>2 ผู้ได้รับมอบหมายให้ปฏิบัติการตรวจสอบภายใน ล้วนๆ 90,000 บาท</p>
            </div>
          </div>
        );
