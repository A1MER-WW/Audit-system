...
import ApSubmitToInspectionModal from "@/components/(ap-risk-assessment)/ap-submit-to-inspection-modal";
          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="mt-3 inline-flex items-center text-xs text-indigo-600 bg-indigo-50 px-2 py-1 rounded-full">
                <span>สถานะ: ผู้ตรวจสอบทบทวนปัจจัยและเกณฑ์การจัดความเสี่ยง</span>
              </div>
            </div>
          </div>
        </div>
