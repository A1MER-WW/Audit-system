...
import ApManageRiskAssessmentsModal from "@/components/(ap-risk-assessment)/ap-manage-risk-assessments-modal";
        ...
        <div className="mt-6 bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="mt-3 inline-flex items-center text-xs text-indigo-600 bg-indigo-50 px-2 py-1 rounded-full">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            {tab === "impact" && (
              <>
                ...
                <button className="rounded-lg border px-3 py-1.5 text-gray-700 hover:bg-gray-100">เพิ่มด้านของปัจจัยเสี่ยง</button>
              </>
            )}
          </div>
        </div>
              ...
              {Object.entries(mockImpactData).map(([title, rows]) => (
                <div key={title}>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <button className="rounded-lg border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-sm text-indigo-700 hover:bg-indigo-100">
                      เพิ่มปัจจัยเสี่ยง
                    </button>
                  </div>
                  <ApImpactTable title="" rows={rows} />
                </div>
              ))}
            </div>
          )}
