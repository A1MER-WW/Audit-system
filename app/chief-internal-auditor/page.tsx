...
import ManageRiskAssessmentsModal from "@/components/chiefinternalauditormodal";
...
export default function ChiefInternalAuditorPage() {
    ...
    <div className="w-full min-h-screen bg-gray-50 text-gray-900">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
        ...
        <p className="mt-3 text-sm text-gray-600">
          สถานะ: <span className="text-yellow-400">รอหัวหน้าพิจารณาปัจจัยและเกณฑ์พิจารณาความเสี่ยง</span>
        </p>
