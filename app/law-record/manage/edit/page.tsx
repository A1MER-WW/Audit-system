...
export default function LowRecordManageEditPage() {
    ...
    <div className="w-full">
        ...
        <Card className="shadow-lg ">
          <div className='content-left ml-4'>
            ...
            <div className="flex">
              <p className=" flex-1 text-muted-foreground text-sm text-balance pt-4 ">
              ลบฐานข้อมูลด้านกฏหมายนี้
              </p>
              <div>
                  <Button variant="outline" className="mt-2 mr-4 bg-red-500 text-[#FFFFFF]">ลบข้อมูล</Button>
              </div>
            </div>
          </div>
        </Card>
