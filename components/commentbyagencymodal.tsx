...
export default function CommentByAgencyModal({
  open,
  value,
  onChange,
  onClose,
      ...
      <div className="relative z-10 w-full max-w-xl rounded-2xl bg-white p-6 shadow-xl">
        <div className="flex items-start justify-between">
          <h2 id="manage-risk-title" className="text-xl font-semibold text-gray-900">
            ยืนยันความเห็นของหน่วยงานตรวจสอบภายใน
          </h2>
          <button
        ...
        <p id="manage-risk-desc" className="mt-1 text-sm text-gray-500">
          ท่านต้องการยืนยันความเห็นของหน่วยงานตรวจสอบภายในหรือไม่
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-end gap-3">
          ...
          <button 
            ...
            onClick={() => {
              console.log('Confirm button clicked, value:', value);
              
              if (value === "want") {
                console.log('User wants to comment, navigating to comment-of-agency');
                onConfirm();
                // ใช้ path ที่ถูกต้องตาม Next.js routing
                router.push('/opinions-of-agency/comment-of-agency');
              } else {
                console.log('User does not want to comment, just closing modal');
                onConfirm();
                // ไม่นำทางไปไหน ถ้าเลือก "ไม่ต้องการ"
              }
            }}
          >
            ยืนยัน
